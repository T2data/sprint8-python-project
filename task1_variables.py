...
#Q1.a total number of games
total_games = len(video_game_sales)
print(total_games)

#Q1.b average global sales across all 20 games
avg_global_sales = 0
total_global_sales = 0

for globalSale in video_game_sales:
    total_global_sales += globalSale[GLOBAL_SALES]
avg_global_sales = total_global_sales/total_games
print(avg_global_sales)

#Q1.c Calculate what percentage of the total global sales index 0 (Wii Sports)  represents
top_game_share = (video_game_sales[0][GLOBAL_SALES] / total_global_sales)*100
#top_game_share = int(top_game_share)
