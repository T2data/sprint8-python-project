...
for game in video_game_sales:
    sales_by_genre[game[GENRE]] = sales_by_genre.get(game[GENRE],0)+game[GLOBAL_SALES]
print(sales_by_genre)

games_per_publisher = {}
for game in video_game_sales:
    publisherName = game[PUBLISHER]
    games_per_publisher[publisherName]=games_per_publisher.get(publisherName,0)+1
